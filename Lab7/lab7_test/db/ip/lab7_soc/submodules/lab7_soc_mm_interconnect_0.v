...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [28:0] acc_s1_agent_m0_address;                                                            // Acc_s1_agent:m0_address -> Acc_s1_translator:uav_address
	...
	wire  [107:0] acc_s1_agent_rf_source_data;                                                        // Acc_s1_agent:rf_source_data -> Acc_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] acc_s1_agent_rsp_fifo_out_data;                                                     // Acc_s1_agent_rsp_fifo:out_data -> Acc_s1_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> Acc_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // Acc_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> Acc_s1_agent:cp_channel
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> Reset_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> Reset_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // Reset_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> Reset_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> Reset_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> Reset_s1_agent:cp_endofpacket
	...
	wire  [106:0] acc_s1_agent_rp_data;                                                               // Acc_s1_agent:rp_data -> router_009:sink_data
	...
	wire          reset_s1_agent_rp_valid;                                                            // Reset_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] reset_s1_agent_rp_data;                                                             // Reset_s1_agent:rp_data -> router_010:sink_data
	wire          reset_s1_agent_rp_ready;                                                            // router_010:sink_ready -> Reset_s1_agent:rp_ready
	wire          reset_s1_agent_rp_startofpacket;                                                    // Reset_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          reset_s1_agent_rp_endofpacket;                                                      // Reset_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          reset_s1_agent_rdata_fifo_src_valid;                                                // Reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] reset_s1_agent_rdata_fifo_src_data;                                                 // Reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          reset_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_008:in_0_ready -> Reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> Reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> Reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // Reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> Reset_s1_agent:rdata_fifo_sink_error
